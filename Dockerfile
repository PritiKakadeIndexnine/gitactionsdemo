# Use an official openjdk:8-jdk runtime as a parent image
FROM openjdk:8-jdk
...
#COPY entrypoint.sh /robot/entrypoint.sh
...
ENV BROWSERSTACK_CONFIG_FILE="robot/browserstack.yml"

#CMD ["browserstack-sdk","pabot", "--testlevelsplit", "Mobile/Android/KC/TestCases/Login/already_registered_user_test.robot","Mobile/IOS/KC/TestCases/FLRP/flrp_test.robot"]
CMD ["browserstack-sdk", "pabot" , "Mobile/Android/KC/TestCases/Login/already_registered_user_test.robot"]

#CMD ["browserstack-sdk","robot","Mobile/IOS/KC/TestCases/FLRP/flrp_test.robot"]
